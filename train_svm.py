...
# 预测
svm_pred_train = multi_target_svc.predict(X_train)
svm_pred_test = multi_target_svc.predict(X_test)

# 计算原有的训练集和测试集得分（子集准确率）
train_score = multi_target_svc.score(X_train, y_train)
test_score = multi_target_svc.score(X_test, y_test)

# 计算二分类准确度
train_custom_accuracy = custom_accuracy(y_train, svm_pred_train)
test_custom_accuracy = custom_accuracy(y_test, svm_pred_test)
...
# 训练集得分： 0.28125
# 测试集得分： 0.27734375
# 训练集二分类准确度： 0.606689453125
# 测试集二分类准确度： 0.62109375
